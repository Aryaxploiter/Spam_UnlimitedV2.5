...
def balik():
    ...
    if f == "":
       os.system("python arya_spamerv2.py")
    else:
       sys.exit()
...
\033[97m
\t------------
\nCreator:\033[97m ARYAZINMAKER
versi: 2.5
Team: INDONESIA CYBER SCURITY
Youtube: ARYA X-PLOIT
Github : github.com/aryaxploiter
...
if __name__=="__main__":
     try:
          ...
          clear()
          kata("\033[92;1m╔═══════════════════════════════╗")
          kata("║ Welcome to Arya Brutal Spamer ║")
          kata("╚═══════════════════════════════╝")
          time.sleep(2)
          time.sleep (2)
          kata("\033[91m╔═╦═╦╗╔═╦══╗╔═╦═╦══╦╦╗╔═╦╦╦╦╦═╗")
